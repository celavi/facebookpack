...
<form action="{$smarty.server.REQUEST_URI}" method="post">
    <fieldset>
		<legend><img src="{$path}views/templates/img/fb.png" />{$common.localizationAndTranslation}</legend>
		...
		<input align="center" type="submit" name="localization-submit" value="{$common.localizationSubmit}" class="button" />
	</fieldset>
</form>